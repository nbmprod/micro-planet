...
export class Environment {
    private readonly _sun: THREE.DirectionalLight;
    private readonly _backSun: THREE.DirectionalLight; // Added secondary light
    private readonly _ambient: THREE.AmbientLight;
    private readonly _hemiLight: THREE.HemisphereLight; // Added ground/sky bounce
